...
EXAMPLES = [
    85751621, 85754178, 85750107, 85753189, 85752142, 85772758,
    85772755, 85753402, 85749125, 85752601, 85748425
]
i = 1

Path('wav/examples').mkdir(parents=True, exist_ok=True)
